 ...
 * @ORM\Entity(repositoryClass="DiaporamaBundle\Repository\GalerieRepository")
...
class Galerie
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="DiaporamaBundle\Entity\Categorie", inversedBy="galeries")
     */
    private $categorie;
    ...
    /**
     * @ORM\OneToMany(targetEntity="DiaporamaBundle\Entity\Image", mappedBy="galerie")
     */
    private $images;
     ...
     * Set categorie
     *
     * @param \DiaporamaBundle\Entity\Categorie $categorie
     *
     * @return Galerie
     */
    public function setCategorie(\DiaporamaBundle\Entity\Categorie $categorie = null)
    {
     ...
     * Get categorie
     *
     * @return \DiaporamaBundle\Entity\Categorie
     */
     ...
     * Add image
     *
     * @param \DiaporamaBundle\Entity\Image $image
     *
     * @return Galerie
     */
    public function addImage(\DiaporamaBundle\Entity\Image $image)
    {
        $this->images[] = $image;
     ...
     * @param \DiaporamaBundle\Entity\Image $image
     */
    public function removeImage(\DiaporamaBundle\Entity\Image $image)
    {
