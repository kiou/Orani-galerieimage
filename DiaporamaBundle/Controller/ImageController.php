...
use DiaporamaBundle\Form\ImageType;
use DiaporamaBundle\Entity\Image;
...
class ImageController extends Controller
{
    ...
    public function ajouterAdminAction(Request $request, Galerie $galerie)
    {
        ...
        return $this->render('DiaporamaBundle:Admin/Image:ajouter.html.twig',
            array(
    ...
    public function managerAdminAction(Galerie $galerie)
    {
        ...
        $images = $this->getDoctrine()
                       ->getRepository('DiaporamaBundle:Image')
        ...
        return $this->render( 'DiaporamaBundle:Admin/Image:manager.html.twig', array(
                'images' => $images,
                'galerie' => $galerie,
                'breadcrumb' => $breadcrumb
            )
    ...
    public function modifierAdminAction(Request $request, Galerie $galerie, Image $image)
    {
        ...
        return $this->render('DiaporamaBundle:Admin/Image:modifier.html.twig',
            array(
                'breadcrumb' => $breadcrumb,
                'galerie' => $galerie,
                'image' => $image,
