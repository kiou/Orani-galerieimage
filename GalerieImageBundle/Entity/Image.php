 ...
 * @ORM\Entity(repositoryClass="GalerieImageBundle\Repository\ImageRepository")
...
class Image
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GalerieImageBundle\Entity\Galerie", inversedBy="images")
     */
    private $galerie;
     ...
     * Set galerie
     *
     * @param \GalerieImageBundle\Entity\Galerie $galerie
     *
     * @return Image
     */
    public function setGalerie(\GalerieImageBundle\Entity\Galerie $galerie = null)
    {
     ...
     * Get galerie
     *
     * @return \GalerieImageBundle\Entity\Galerie
     */
