...
namespace GalerieImageBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="GalerieImageBundle\Repository\GalerieRepository")
...
class Galerie
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="GalerieImageBundle\Entity\Categorie", inversedBy="galeries")
     */
    private $categorie;
    ...
    /**
     * @ORM\OneToMany(targetEntity="GalerieImageBundle\Entity\Image", mappedBy="galerie")
     */
    private $images;
    ...
    {
        return __DIR__.'/../../../web/img/galerie/';
    }
     ...
     * Set categorie
     *
     * @param \GalerieImageBundle\Entity\Categorie $categorie
     *
     * @return Galerie
     */
    public function setCategorie(\GalerieImageBundle\Entity\Categorie $categorie = null)
    {
     ...
     * Get categorie
     *
     * @return \GalerieImageBundle\Entity\Categorie
     */
     ...
     * Add image
     *
     * @param \GalerieImageBundle\Entity\Image $image
     *
     * @return Galerie
     */
    public function addImage(\GalerieImageBundle\Entity\Image $image)
    {
        $this->images[] = $image;
     ...
     * @param \GalerieImageBundle\Entity\Image $image
     */
    public function removeImage(\GalerieImageBundle\Entity\Image $image)
    {
